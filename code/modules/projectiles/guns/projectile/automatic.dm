...
/obj/item/weapon/gun/projectile/automatic/ak47
	name = "AK-47"
	desc = "The rugged AK-47 is a reliable, old world weapon. Uses 7.62mm rounds."
	icon_state = "ak47"
	item_state = "ak47"
	...
	allowed_magazines = list(/obj/item/ammo_magazine/ak47)
	projectile_type = /obj/item/projectile/bullet/rifle/a762
...
/obj/item/weapon/gun/projectile/automatic/ak47/update_icon()
	...
	if(ammo_magazine)
		...
		icon_state = "ak47-open"
		item_state = "ak47-open"
...
/obj/item/weapon/gun/projectile/automatic/ak47/makeshift
	...
	desc = "A shoddily made, makeshift AK-47.. Uses 7.62mm rounds."
	icon_state = "makeshiftak47"

	firemodes = list(
		list(mode_name="semiauto",       burst=1, fire_delay=0,    move_delay=null, burst_accuracy=null, dispersion=null),
		list(mode_name="3-round bursts", burst=3, fire_delay=null, move_delay=6,    burst_accuracy=list(0,-25,-40), dispersion=list(0.0, 0.6, 0.6))
//		list(mode_name="short bursts", 	burst=5, fire_delay=null, move_delay=6,    burst_accuracy=list(0,-25,-40,-40,-55), dispersion=list(0.6, 1.0, 1.0, 1.0, 1.2)),
		)
