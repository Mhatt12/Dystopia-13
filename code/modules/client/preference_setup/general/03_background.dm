...
/datum/category_item/player_setup_item/general/background/content(var/mob/user)
	...
	if(!pref.existing_character)
		. += "Genesis City is on the planet Mars, and is located in the Sol star system. You may choose a different background. Social class and the system you are born in cannot be changed once set.</br><br>"
